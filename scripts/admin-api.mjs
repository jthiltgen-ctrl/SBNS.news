...
class FakeDB {
  constructor(){this.s={intakes:[],analyses:[],drafts:[],decisions:[],audit:[],idem:[]};this.failAudit=false}
...
async function call(handler,db,path,options){return handler(request(path,options),{SBNS_DB:db,ADMIN_ASSETS:{fetch:()=>new Response("asset")}})}
